...
<div class="wrapper">
    ...
    <div class="page-header">
        <div class="logo"><svg class="icon-svg"><use href="#i-truck" xlink:href="#i-truck"></use></svg></div>
        <h1>Rastreamento de Entregas</h1>
        <p>Consulta de ocorrências por nota fiscal &middot; AD_OCORRENCIAS</p>
    </div>

    <!-- SEARCH -->
    <div class="search-card">
        <h2><svg class="icon-svg icon-gap"><use href="#i-search" xlink:href="#i-search"></use></svg>Pesquisar Nota Fiscal</h2>
        <div class="search-row">
            ...
            <button class="btn-search" id="btnRastrear" onclick="rastrear()"><svg class="icon-svg icon-gap"><use href="#i-search" xlink:href="#i-search"></use></svg>Rastrear</button>
    ...
    <div class="welcome-state" id="welcome">
        <div class="icon"><svg class="icon-svg"><use href="#i-box" xlink:href="#i-box"></use></svg></div>
...
function renderResultado(rows) {
    ...
    det.innerHTML =
        ...
        '</div>' +
        (rastreio ? '<div class="detail-item"><label>Cód. Rastreio</label><span>' + icon('bookmark') + ' ' + esc(rastreio) + '</span></div>' : '');
    ...
    rows.forEach(function(r) {
        ...
        var tRast    = field(r, 'CODIGORASTREIO');
        var tAgend   = field(r, 'AGENDAMENTOENTREGA');
        var tPrenota = field(r, 'NUMEROPRENOTA');
        ...
        if (tRast)   metaItems.push(icon('bookmark') + ' ' + esc(tRast));
        if (tAgend)  metaItems.push(icon('calendar') + ' Agend.: ' + esc(tAgend));
        if (tPrenota)metaItems.push(icon('file') + ' Pré-nota: <strong>' + esc(tPrenota) + '</strong>');
